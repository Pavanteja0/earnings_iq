...
class SynthesisAgent(BaseAgent):
    ...
    def get_mock_response(self, user_prompt: str) -> str:
        return (
            ...
            "---"
            "### Executive Summary\n"
            "Acme Corporation delivered a solid Q3 2026 performance, beating revenue expectations at $12.45B (+10% YoY) "
            "and showing resilient Gross Profit Margins of 44.2% (+70 bps YoY) [10-Q, Page 12]. The expansion was driven "
            "primarily by strong momentum in Cloud Services (+15.5% YoY) [10-Q, Page 16]. However, the quarter was marked "
            "by structural headwind pressures on operating expenses and severe CapEx investments, which grew faster than top-line revenues.\n\n"
            "The analyst call revealed management defensiveness regarding Cloud Division margin compression sequentially, "
            "attributing it to accelerated server depreciation [Earnings Call, Q&A, 32:45]. While management maintains "
            "confidence in its enterprise SaaS shift, near-term hardware headwinds in Europe represent a key risk [Earnings Call, Q&A, 41:10]. "
            "We remain bullish on ACME's long-term enterprise market share, but advise near-term margin caution.\n\n"
            "---"
            ...
            "**Alignment Rationale**: There is a strong consistency between management's remarks on SaaS transformation momentum "
            "and the segments reported in the 10-Q (+15.5% SaaS revenue). However, we penalize the score by 2 points because management "
            "downplayed the operating expense growth rate on the call, which actual disclosures showed was growing at 12.1% YoY (outpacing revenue growth). "
            "The citations verified that statements on pricing power and cash reserve strength are fully backed by 10-Q balance sheets."
        )
